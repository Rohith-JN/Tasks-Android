  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: Container(
          ...
          child: (arrayController.allTodos.isEmpty)
              ? const Center(
              ...
              : GetX<ArrayController>(
                  ...
                  builder: (ArrayController arrayController) {
                    return ListView.separated(
                        ...
                        itemBuilder: (context, index) => Padding(
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      arrayController.allTodos[index].title!,
                                      style: GoogleFonts.notoSans(
                                          ...
                                          child: Obx(
                                            () => Padding(
                                              padding: const EdgeInsets.only(
                                                  bottom: 5.0),
                                              child: Text(
                                                (arrayController.allTodos[index]
                                                            .date !=
                                                        now)
                        ...
                        itemCount: arrayController.allTodos.length);
                  }),
        ));
  }
}
